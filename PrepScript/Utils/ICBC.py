...
def Ungrib_CESM2_ssp245(casecfg, envcfg, gridname, start_time, end_time):
    old_path = os.getcwd()
    ForcingDataName = casecfg.get(gridname, 'ForcingDataName')
    ForcingDataName = ForcingDataName.strip().lower()
    CaseOutputPath = casecfg.get(gridname, 'CaseOutputPath')
...
def Ungrib_CESM2_ssp585(casecfg, envcfg, gridname, start_time, end_time):
    old_path = os.getcwd()
    ForcingDataName = casecfg.get(gridname, 'ForcingDataName')
    ForcingDataName = ForcingDataName.strip().lower()
    CaseOutputPath = casecfg.get(gridname, 'CaseOutputPath')
...
def Ungrib(casecfg, envcfg, gridname, start_time, end_time):
    ...
    elif ForcingDataName == 'cesm2_ssp245':
        # Call the CESM2_ssp245 Ungrib function
        Ungrib_CESM2_ssp245(casecfg, envcfg, gridname, start_time, end_time)
    elif ForcingDataName == 'cesm2_ssp585':
        # Call the CESM2_ssp585 Ungrib function
        Ungrib_CESM2_ssp585(casecfg, envcfg, gridname, start_time, end_time)
    else:
