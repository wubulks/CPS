...
def Ungrib(casecfg, envcfg, gridname, start_time, end_time):
    ...
    if ForcingDataName == 'cfsv2':
        ...
        logger.error("Supported driver data is : 'CFSV2' or 'ERA5' or 'MPI-ESM1-2-HR_hist' or 'MPI-ESM1-2-HR_ssp245'.")
        raise ValueError(f"Unsupported ForcingDataName: {ForcingDataName}. Please use 'CFSV2' or 'ERA5' or 'MPI-ESM1-2-HR_hist' or 'MPI-ESM1-2-HR_ssp245'.")
