...
# ===== 配置参数 =====
start_year = 2026 # 修改点1：起报年份2012-2025
end_year = 2026
...
# ===== 开始检查 =====
print(f"开始检查 CFSv2 地面场预报数据文件是否存在且大于 {sfckb/1024:.1f} MB...")
...
for year in range(start_year, end_year + 1):
    ...
    # 计算结束时间（10月1日00时）
    end_date = datetime(year, 12, 31, 0) #修改点3：起报月份和结束月份3-10；4-11；5-12；6-1(按12.31算)
    ...
    # 地面场数据检查
    flux_dir = os.path.join(base_dir, "operational-9-month-forecast", "6-hourly-flux", '060100',str(year)) #修改点4：起报月份和日期060100...
