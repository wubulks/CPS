r'''
Author: ChenHJ
Date: 2025-01-25 18:01:08
LastEditors: ChenHJ
LastEditTime: 2025-01-25 18:58:54
FilePath: /CWRF_icbc_pure/SCRIPTS/ICBCScripts/PrepICBC/ERA5_sfc_download.py
Description: 
'''
...
def download_era5_data(year, month, day, download_dir):
    ...
    filename = "SFC{}.grib".format(date_string)
...
download_log = r"/tera07/zhangsl/wumej22/Omarjan/ERA5_RAW/log.era5_sf_"+str(start_year)  # 下载日志文件，如果使用slurm或lsf作业提交系统，务必在代码中实时重定向log，以便提取下载失败的url
# ========================CONFIG================================
